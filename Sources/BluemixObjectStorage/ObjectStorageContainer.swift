...
public class ObjectStorageContainer{
	...
	*/
	public func storeObject(name:String, data:Data, completionHandler: @escaping (_ error: ObjectStorageError?, _ object: ObjectStorageObject?)->Void){
	...
	*/
	public func retrieveObject(name:String, completionHandler: @escaping (_ error: ObjectStorageError?, _ object: ObjectStorageObject?)->Void){
	...
	*/
	public func retrieveObjectsList(completionHandler: @escaping (_ error: ObjectStorageError?, _ objects: [ObjectStorageObject]?)->Void){
	...
	*/
	public func deleteObject(name: String, completionHandler: @escaping (_ error:ObjectStorageError?) -> Void){
